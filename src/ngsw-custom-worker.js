// clone of angular's ngsw-worker.js with a 'returnRangeRequest' function
...
(function () {
    ...
    class Driver {
        ...
        onFetch(event) {
            ...
            //     var matches = url.match(/[^\/]+chunk\.js|assets\/.*/);
            //     return matches && matches[0];
            // }

            // var localAssetUrl = getLocalAsset(event.request.url);
            // if (localAssetUrl) {
            //     var newUrl = "http://localhost:4200/" + localAssetUrl;
